...
<div id="app">
    ...
    <div class="container">
        ...
        <div class="col-lg-4 col-md-12">
            ...
            <form method="post" action="{{url("contentmenu/update/$id->id")}}" class="form-group" style="direction: rtl;">
                ...
                <input type="text" name="linkmenu" value="{{$id->linkmenu}}" class="form-control" style="margin-top: 5px;">
